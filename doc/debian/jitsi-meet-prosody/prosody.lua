...
VirtualHost "meet.sonacove.com"
    ...
    -- use the global one.
    ssl = {
        key = "/etc/prosody/certs/meet.sonacove.com.key";
        certificate = "/etc/prosody/certs/meet.sonacove.com.crt";
    }
...
VirtualHost "auth.meet.sonacove.com"
    ssl = {
        key = "/etc/prosody/certs/auth.meet.sonacove.com.key";
        certificate = "/etc/prosody/certs/auth.meet.sonacove.com.crt";
    }
    modules_enabled = {
        "limits_exception";
        "smacks";
